...
<body>
    ...
    <div class="form-container">
        ...
        <form id="loginForm" action="../../../Controller/auth.php?action=login" method="POST">
        ...
        <div class="social-login-wrapper">
            <a href="../../../Controller/google_login.php" class="social-btn google-btn">
            ...
            <a href="../../../Controller/github_login.php" class="social-btn github-btn">
