...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $utilisateurModel->modifierUtilisateurFront($id, $prenom, $nom, $email);
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../Back/Back/styles/core.css">
    <link rel="stylesheet" type="text/css" href="../../Back/Back/styles/icon-font.min.css">
    <link rel="stylesheet" type="text/css" href="../../Back/Back/styles/style.css">
</head>
<body>
    <!-- Header -->
    <div class="header">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" role="button">
                        <span class="user-icon">
                            <img src="../../Back/Back/images/photo1.jpg" alt="">
                        </span>
    ...
    <div class="left-side-bar">
        <div class="brand-logo">
            <a href="#">
                <img src="../../Back/Back/images/logoicon.png" alt="" class="dark-logo">
                <img src="../../Back/Back/images/logo.png" alt="" class="light-logo">
            </a>
